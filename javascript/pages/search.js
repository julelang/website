...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "common", "concept", "control", "loop", "flow", "if", "else"], "Documentations - <strong>5.4.</strong> Control Flow",             "Control Flow sub-topic of Common Concepts topic of documentations.",        `${root_path}/pages/docs.html?page=common-concepts-control-flow`],
