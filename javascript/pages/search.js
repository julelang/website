...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "cxx"],                                                                "Documentations - <strong>8.</strong> Cxx",                        "Cxx topic of documentations.",                                              `${root_path}/pages/docs.html?page=cxx`],
  [["doc", "info", "guide", "learn", "cxx", "api"],                                                         "Documentations - <strong>8.1.</strong> CxxAPI",                   "CxxAPI sub-topic of Types topic of documentations.",                        `${root_path}/pages/docs.html?page=cxx-cxxapi`],
