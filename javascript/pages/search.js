...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "type", "slice"],                                                        "Documentations - <strong>8.6.</strong> Slices",                   "Slices sub-topic of Types topic of documentations.",                        `${root_path}/pages/docs.html?page=types-slices`],
  [["doc", "info", "guide", "learn", "type", "map", "hash"],                                                  "Documentations - <strong>8.7.</strong> Maps",                     "Maps sub-topic of Types topic of documentations.",                          `${root_path}/pages/docs.html?page=types-maps`],
  ...
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "slice"],                                      "Documentations - <strong>stdlib:</strong> slice",                 "The slice stdlib documentations.",                                          `${root_path}/pages/stdlib/slice.html`],
  ...
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "math", "bits"],                               "Documentations - <strong>stdlib:</strong> math.bits",             "The math.bits stdlib documentations.",                                      `${root_path}/pages/stdlib/math_bits.html`],
