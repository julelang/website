...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "mem", "point", "ptr", "alloc", "heap", "stack"],                        "Documentations - <strong>7.1.</strong> Pointers",                 "Pointers sub-topic of Memory topic of documentations.",                      `${root_path}/pages/docs.html?page=memory-pointers`],
  [["doc", "info", "guide", "learn", "mem", "manage", "new", "alloc", "heap", "point", "free", "ptr"],        "Documentations - <strong>7.2.</strong> Memory Management",        "Memory Management sub-topic of Memory topic of documentations.",             `${root_path}/pages/docs.html?page=memory-memory-management`],
  [["doc", "info", "guide", "learn", "mem", "ptr", "ref", "lvalue", "rvalue"],                                "Documentations - <strong>7.3.</strong> References",               "References sub-topic of Memory topic of documentations.",                    `${root_path}/pages/docs.html?page=memory-references`],
  ...
  [["doc", "info", "guide", "learn", "err", "panic", "hand", "catch", "trait", "custom"],                     "Documentations - <strong>9.1.</strong> Error Trait",              "Error Trait sub-topic of Error Handling topic of documentations.",           `${root_path}/pages/docs.html?page=error-handling-error-trait`],
  [["doc", "info", "guide", "learn", "err", "panic", "abort", "exception", "throw"],                          "Documentations - <strong>9.2.</strong> Panics",                   "Panics sub-topic of Error Handling topic of documentations.",                `${root_path}/pages/docs.html?page=error-handling-panics`],
  [["doc", "info", "guide", "learn", "err", "panic", "hand", "exception", "throw", "recover"],                "Documentations - <strong>9.3.</strong> Handling Panics",          "Handling Panics sub-topic of Error Handling topic of documentations.",       `${root_path}/pages/docs.html?page=error-handling-handling-panics`],
  ...
  [["doc", "info", "guide", "learn", "json", "metadoc"],                                                      "Documentations - <strong>13</strong> Documenting",                "Documenting topic of documentations.",                                       `${root_path}/pages/docs.html?page=documenting`],
  [["doc", "info", "guide", "learn", "json", "metadoc", "comment"],                                           "Documentations - <strong>13.1</strong> Documentation Comments",   "Documentation Comments sub topic of Documenting topic of documentations.",   `${root_path}/pages/docs.html?page=documenting-documentation-comments`],
  [["doc", "info", "guide", "learn", "json", "metadoc"],                                                      "Documentations - <strong>13.2</strong> Using Documenter",         "Using Documenter sub topic of Documenting topic of documentations.",         `${root_path}/pages/docs.html?page=documenting-using-documenter`],
