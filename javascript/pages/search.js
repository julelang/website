...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "common", "concept", "control", "loop", "flow", "if", "else", "iter"], "Documentations - <strong>5.4.</strong> Control Flow",             "Control Flow sub-topic of Common Concepts topic of documentations.",        `${root_path}/pages/docs.html?page=common-concepts-control-flow`],
  ...
  [["doc", "info", "guide", "learn", "std", "standard", "lib"],                                             "Documentations - <strong>9</strong> Standard Library",            "Standard Library topic of documentations.",                                 `${root_path}/pages/docs.html?page=standard-library`],
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "built"],                                    "Documentations - <strong>9.1</strong> Built-In",                  "Standard Library sub topic of Standard Library topic of documentations.",   `${root_path}/pages/docs.html?page=standard-library-builtin`],
  ...
  [["doc", "info", "guide", "learn", "pre", "process"],                                                     "Documentations - <strong>12.</strong> Types",                      "Preprocessor topic of documentations.",                                     `${root_path}/pages/docs.html?page=preprocessor`],
  [["doc", "info", "guide", "learn", "pre", "process", "directive", "pragma"],                              "Documentations - <strong>12.1.</strong> Aliasing",                 "Directives sub-topic of Preprocessor topic of documentations.",             `${root_path}/pages/docs.html?page=preprocessor-directives`],
