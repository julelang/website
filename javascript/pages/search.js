...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "debug", "assert"],                            "Documentations - <strong>15.2</strong> debug",                    "The debug stdlib documentations.",                                          `${root_path}/pages/docs.html?page=stdlib-debug`],
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "debug", "assert"],                            "Documentations - <strong>15.2.1</strong> assert",                 "The debug.assert stdlib documentations.",                                   `${root_path}/pages/docs.html?page=stdlib-debug-assert`],
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "io"],                                         "Documentations - <strong>15.3</strong> io",                       "The io stdlib documentations.",                                             `${root_path}/pages/docs.html?page=stdlib-io`],
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "os"],                                         "Documentations - <strong>15.4</strong> mem",                      "The mem stdlib documentations.",                                            `${root_path}/pages/docs.html?page=stdlib-mem`],
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "os"],                                         "Documentations - <strong>15.5</strong> os",                       "The io stdlib documentations.",                                             `${root_path}/pages/docs.html?page=stdlib-os`],
