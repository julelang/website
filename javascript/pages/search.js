...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "err", "panic", "hand", "exception", "throw", "recover"],                "Documentations - <strong>7.3.</strong> Handling Panics",          "Handling Panics sub-topic of Error Handling topic of documentations.",      `${root_path}/pages/docs.html?page=error-handling-handling-panics`],
