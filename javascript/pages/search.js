...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "compile", "transpile", "cfg", "config", "set"],                         "Documentations - <strong>2.3.</strong> Config Files",             "Config Files sub-topic of Compiler topic of documentations.",                `${root_path}/pages/docs.html?page=compiler-config-files`],
