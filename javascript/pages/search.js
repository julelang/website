...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "debug", "assert"],                            "Documentations - <strong>15.2</strong> debug",                    "debug stdlib documentations.",                                              `${root_path}/pages/docs.html?page=stdlib-debug`],
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "debug", "assert"],                            "Documentations - <strong>15.2.1</strong> assert",                 "debug.assert stdlib documentations.",                                       `${root_path}/pages/docs.html?page=stdlib-debug-assert`],
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "io"],                                         "Documentations - <strong>15.3</strong> io",                       "io stdlib documentations.",                                                 `${root_path}/pages/docs.html?page=stdlib-io`],
  [["doc", "info", "guide", "learn", "std", "standard", "lib", "os"],                                         "Documentations - <strong>15.4</strong> os",                       "io stdlib documentations.",                                                 `${root_path}/pages/docs.html?page=stdlib-os`],
