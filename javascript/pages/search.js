...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "type", "static", "built", "size"],                                      "Documentations - <strong>9.11.</strong> size",                    "size sub-topic of Type Statics topic of documentations.",                   `${root_path}/pages/docs.html?page=type-statics-size`],
  [["doc", "info", "guide", "learn", "type", "static", "built", "str"],                                       "Documentations - <strong>9.12.</strong> str",                     "str sub-topic of Type Statics topic of documentations.",                    `${root_path}/pages/docs.html?page=type-statics-str`],
