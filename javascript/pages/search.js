...
const contents = [
  ...
  [["doc", "info", "guide", "learn", "err", "panic", "hand"],                                                 "Documentations - <strong>8.1.</strong> Error Structure",          "Error Structure sub-topic of Error Handling topic of documentations.",      `${root_path}/pages/docs.html?page=error-handling-error-structure`],
  ...
  [["doc", "info", "guide", "learn", "type", "static", "built", "str"],                                       "Documentations - <strong>10.13.</strong> str",                     "str sub-topic of Type Statics topic of documentations.",                    `${root_path}/pages/docs.html?page=type-statics-str`],
  [["doc", "info", "guide", "learn", "name", "space", "scope", "group"],                                      "Documentations - <strong>11.</strong> Namespaces",                "Namespaces topic of documentations.",                                       `${root_path}/pages/docs.html?page=namespaces`],
  [["doc", "info", "guide", "learn", "cxx", "api", "embed"],                                                  "Documentations - <strong>12.</strong> Cxx",                       "Cxx topic of documentations.",                                              `${root_path}/pages/docs.html?page=cxx`],
  [["doc", "info", "guide", "learn", "cxx", "api", "embed"],                                                  "Documentations - <strong>12.1.</strong> Cxx Embedding",           "Cxx Embedding sub-topic of Types topic of documentations.",                 `${root_path}/pages/docs.html?page=cxx-cxx-embedding`],
  [["doc", "info", "guide", "learn", "cxx", "api", "embed"],                                                  "Documentations - <strong>12.2.</strong> CxxAPI",                  "CxxAPI sub-topic of Types topic of documentations.",                        `${root_path}/pages/docs.html?page=cxx-cxxapi`],
  [["doc", "info", "guide", "learn", "json", "xdoc"],                                                         "Documentations - <strong>13</strong> Documenting",                "Documenting topic of documentations.",                                      `${root_path}/pages/docs.html?page=documenting`],
  [["doc", "info", "guide", "learn", "json", "xdoc", "comment"],                                              "Documentations - <strong>13.1</strong> Documentation Comments",   "Documentation Comments sub topic of Documenting topic of documentations.",  `${root_path}/pages/docs.html?page=documenting-documentation-comments`],
  [["doc", "info", "guide", "learn", "json", "xdoc"],                                                         "Documentations - <strong>13.2</strong> Using Documenter",         "Using Documenter sub topic of Documenting topic of documentations.",        `${root_path}/pages/docs.html?page=documenting-using-documenter`],
  [["doc", "info", "guide", "learn", "use", "decl", "pkg", "pack"],                                           "Documentations - <strong>14</strong> Use Declarations",           "Use Declarations topic of documentations.",                                 `${root_path}/pages/docs.html?page=use-declarations`],
  [["doc", "info", "guide", "learn", "pre", "process"],                                                       "Documentations - <strong>15.</strong> Preprocessor",              "Preprocessor topic of documentations.",                                     `${root_path}/pages/docs.html?page=preprocessor`],
  [["doc", "info", "guide", "learn", "pre", "process", "directive", "pragma"],                                "Documentations - <strong>15.1.</strong> Directives",              "Directives sub-topic of Preprocessor topic of documentations.",             `${root_path}/pages/docs.html?page=preprocessor-directives`],
  [["doc", "info", "guide", "learn", "std", "standard", "lib"],                                               "Documentations - <strong>16</strong> Standard Library",           "Standard Library topic of documentations.",                                 `${root_path}/pages/docs.html?page=stdlib`],
