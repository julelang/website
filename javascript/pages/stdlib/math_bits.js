const stdlib_math_bits_constantsHTML = `
<div class="sub-sub-title"><x class="inline_code">pub const UINT_SIZE</x></div>
...
<div class="topic-separator"></div>
<div class="code">pub fn trailing_zeros(x: uint) int</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn rotate_left(x: uint, k: int) uint</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn rotate_left8(x: u8, k: int) u8</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn rotate_left16(x: u16, k: int) u16</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn rotate_left32(x: u32, k: int) u32</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn rotate_left64(x: u64, k: int) u64</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn reverse(x: uint) uint</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn reverse_bytes(x: uint) uint</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn len(x: uint) int</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn add(x: uint, y: uint, carry: uint) (sum: uint, carry_out: uint)</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn add32(x: u32, y: u32, carry: u32) (sum: u32, carryout: u32)</div>
Returns the sum with carry of x, y and carry: sum = x + y + carry.
The carry input must be 0 or 1; otherwise the behavior is undefined.
The carryout output is guaranteed to be 0 or 1.
...
<div class="topic-separator"></div>
<div class="code">pub fn add64(x: u64, y: u64, carry: u64) (sum: u64, carryout: u64)</div>
Returns the sum with carry of x, y and carry: sum = x + y + carry.
The carry input must be 0 or 1; otherwise the behavior is undefined.
The carryout output is guaranteed to be 0 or 1.
...
<div class="topic-separator"></div>
<div class="code">pub fn sub(x: uint, y: uint, borrow: uint) (diff: uint, borrow_out: uint)</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn sub32(x: u32, y: u32, borrow: u32) (diff: u32, borrowout: u32)</div>
Returns the difference of x, y and borrow, diff = x - y - borrow.
The borrow input must be 0 or 1; otherwise the behavior is undefined.
The borrowout output is guaranteed to be 0 or 1.
...
<div class="topic-separator"></div>
<div class="code">pub fn sub64(x: u64, y: u64, borrow: u64) (diff: u64, borrowout: u64)</div>
Returns the difference of x, y and borrow: diff = x - y - borrow.
The borrow input must be 0 or 1; otherwise the behavior is undefined.
The borrowout output is guaranteed to be 0 or 1.
...
<div class="topic-separator"></div>
<div class="code">pub fn mul(x: uint, y: uint) (hi: uint, lo: uint)</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn mul32(x: u32, y: u32) (hi: u32, lo: u32)</div>
Returns the 64-bit product of x and y: (hi, lo) = x * y
with the product bits' upper half returned in hi and the lower
half returned in lo.
...
<div class="topic-separator"></div>
<div class="code">pub fn mul64(x: u64, y: u64) (hi: u64, lo: u64)</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn div(hi: uint, lo: uint, y: uint) (quo: uint, rem: uint)</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn div32(hi: u32, lo: u32, y: u32) (quo: u32, rem: u32)</div>
Returns the quotient and remainder of (hi, lo) divided by y: <br>
quo = (hi, lo)/y, rem = (hi, lo)%y with the dividend bits' upper
half in parameter hi and the lower half in parameter lo. <br>
...
<div class="topic-separator"></div>
<div class="code">pub fn rem(hi: uint, lo: uint, y: uint) uint</div>
...
<div class="topic-separator"></div>
<div class="code">pub fn rem64(hi: u64, lo: u64, y: u64) u64</div>
...
const NAV_stdlib_math_bits_constants = document.getElementById("constants");
...
stdlib_math_bits_nav.navigations = [
    [NAV_stdlib_math_bits_constants, stdlib_math_bits_constantsHTML],
