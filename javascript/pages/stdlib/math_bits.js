...
<div class="topic-separator"></div>
<div class="code">pub add32(x: u32, y: u32, carry: u32) [sum: u32, carryout: u32]</div>
...
<div class="topic-separator"></div>
<div class="code">pub add64(x: u64, y: u64, carry: u64) [sum: u64, carryout: u64]</div>
Returns the sum with carry of x, y and carry: sum = x + y + carry.
The carry input must be 0 or 1; otherwise the behavior is undefined.
The carryout output is guaranteed to be 0 or 1.
...
<div class="topic-separator"></div>
<div class="code">pub sub32(x: u32, y: u32, borrow: u32) [diff: u32, borrowout: u32]</div>
...
<div class="topic-separator"></div>
<div class="code">pub sub64(x: u64, y: u64, borrow: u64) [diff: u64, borrowout: u64]</div>
Returns the difference of x, y and borrow: diff = x - y - borrow.
The borrow input must be 0 or 1; otherwise the behavior is undefined.
The borrowout output is guaranteed to be 0 or 1.
...
<div class="topic-separator"></div>
<div class="code">pub mul32(x: u32, y: u32) [hi: u32, lo: u32]</div>
...
<div class="topic-separator"></div>
<div class="code">pub mul64(x: u64, y: u64) [hi: u64, lo: u64]</div>
...
<div class="topic-separator"></div>
<div class="code">pub div32(hi: u32, lo: u32, y: u32) [quo: u32, rem: u32]</div>
...
<div class="topic-separator"></div>
<div class="code">pub div64(hi: u64, lo: u64, y: u64) [quo: u64, rem: u64]</div>
Returns the quotient and remainder of (hi, lo) divided by y: <br>
quo = (hi, lo)/y, rem = (hi, lo)%y with the dividend bits' upper
half in parameter hi and the lower half in parameter lo. <br>
...
<div class="topic-separator"></div>
<div class="code">@inline
pub rem32(hi: u32, lo: u32, y: u32) u32</div>
Returns the remainder of (hi, lo) divided by y. rem32 panics
for y == 0 (division by zero) but, unlike div32, it doesn't panic
on a quotient overflow.

<div class="topic-separator"></div>
<div class="code">pub rem64(hi: u64, lo: u64, y: u64) u64</div>
