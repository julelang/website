...
<div class="topic-separator"></div>
<div class="code">@inline
pub compare_swap_i32(addr *i32, old: i32, new: i32) [swapped: bool]</div>
Executes the compare-and-swap operation for an i32 value.

<div class="topic-separator"></div>
<div class="code">@inline
pub compare_swap_i64(addr: *i64, old: i64, new: i64) [swapped: bool]</div>
Executes the compare-and-swap operation for an i64 value.

<div class="topic-separator"></div>
<div class="code">@inline
pub compare_swap_u32(addr: *u32, old: u32, new: u32) [swapped: bool]</div>
Executes the compare-and-swap operation for an u32 value.

<div class="topic-separator"></div>
<div class="code">@inline
pub compare_swap_u64(addr: *u64, old: u64, new: u64) [swapped: bool]</div>
Executes the compare-and-swap operation for an u64 value.

<div class="topic-separator"></div>
<div class="code">@inline
pub compare_swap_uintptr(addr: *uintptr, old: uintptr, new: uintptr) [swapped: bool]</div>
