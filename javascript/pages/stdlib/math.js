const stdlib_math_globalsHTML = `
<div class="sub-sub-title"><x class="inline_code">const E: f64</x></div>

<div class="topic-separator"></div>
<div class="sub-sub-title"><x class="inline_code">const PI: f64</x></div>

<div class="topic-separator"></div>
<div class="sub-sub-title"><x class="inline_code">const PHI: f64</x></div>

<div class="topic-separator"></div>
<div class="sub-sub-title"><x class="inline_code">const SQRT2: f64</x></div>

<div class="topic-separator"></div>
<div class="sub-sub-title"><x class="inline_code">const SQRT_E: f64</x></div>

<div class="topic-separator"></div>
<div class="sub-sub-title"><x class="inline_code">const SQRT_PI: f64</x></div>

<div class="topic-separator"></div>
<div class="sub-sub-title"><x class="inline_code">const SQRT_PHI: f64</x></div>

<div class="topic-separator"></div>
<div class="sub-sub-title"><x class="inline_code">const LN2: f64</x></div>

<div class="topic-separator"></div>
<div class="sub-sub-title"><x class="inline_code">const LOG_2E: f64</x></div>

<div class="topic-separator"></div>
<div class="sub-sub-title"><x class="inline_code">const LN10: f64</x></div>

<div class="topic-separator"></div>
<div class="sub-sub-title"><x class="inline_code">const LOG_10E: f64</x></div>
`;
...
const NAV_stdlib_math_globals = document.getElementById("globals");
...
stdlib_math_nav.navigations = [
    [NAV_stdlib_math_globals, stdlib_math_globalsHTML],
