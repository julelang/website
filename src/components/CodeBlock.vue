...
<template>
  <div class="bg-[var(--bg-tertiary)]">
    <div class="max-w-(--breakpoint-lg) mx-auto px-5 py-20">
      ...
      <pre id="code-block" class="overflow-auto h-96 mb-5 p-5 bg-[#23272e] text-white rounded-xs"></pre>
      <select @change="changeSelect()" id="select" class="p-2 bg-[var(--color-primary)] hover:bg-[var(--color-primary-darker)] duration-[0.3s] text-white text-sm rounded-xs" style="-webkit-appearance: none;">
