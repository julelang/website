<template>
  <main class="max-w-(--breakpoint-lg) mx-auto px-5 py-30">
    ...
    <div>
      Julenours are everyone in the Jule community. Please be like a true Julenour:
    </div>
    <ul class="ml-8">
      <li>Friendly</li>
      <li>
        ...
        <ul class="ml-8">
          <li>
            Note that not everyone uses their native language and may have different
      ...
      <li>
        ...
        <ul class="ml-8">
          <li>
            Stay focused, start a different discussion to talk about something else.
          </li>
          <li>
            Don't just criticize, explain why you're criticizing and what you think.
          </li>
          <li>
            Do not disparage either party, especially when making a comparison. Do not
            display offensive, humiliating or sarcastic attitudes towards anything.
          </li>
        </ul>
      </li>
    </ul>
    ...
    <div>
      ...
      <a href="https://www.contributor-covenant.org/faq" target="_blank">here</a>.
    </div>
    <div>
