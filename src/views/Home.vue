...
<template>
  <main>
    ...
    <div class="max-w-screen-lg mx-auto py-20 px-5 grid grid-cols-2 max-sm:grid-cols-1 gap-y-20 gap-x-10 leading-5">
      ...
      <div>
        <div class="font-semibold text-2xl mb-2">Interoperability</div>
      ...
      <div>
        <div class="font-semibold text-2xl mb-2">Effective</div>
